...
from .views import informacionPersonal, login, nav, ajaxGrado,borraAjax,Participacionajax, borrar_publicacion,borrar_comunidad, borrar_reconocimiento,guardar_reconocimiento,guardar_publicacion
