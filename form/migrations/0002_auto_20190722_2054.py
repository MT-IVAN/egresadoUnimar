# Generated by Django 2.2.3 on 2019-07-23 01:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='degrees',
            name='nivel_educacion_formal',
            field=models.CharField(blank=True, choices=[('Pregrado', 'Pregrado'), ('Especialización', 'Especialización'), ('Maestría', 'Maestría'), ('Doctorado', 'Doctorado')], max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='participaciones',
            name='ambitoParticipacion',
            field=models.CharField(blank=True, choices=[('Local', 'Local'), ('Regional', 'Regional'), ('Nacional', 'Nacional'), ('Internacional', 'Internacional')], max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='participaciones',
            name='tipoDeComunidad',
            field=models.CharField(blank=True, choices=[('Académica', 'Académica'), ('Profesional', 'Profesional'), ('Científica', 'Científica'), ('Artística / cultural', 'Artística / cultural'), ('Deportiva', 'Deportiva')], max_length=100, null=True),
        ),
        migrations.AlterField(
            model_name='publicaciones',
            name='tipo_publicacion',
            field=models.CharField(blank=True, choices=[('Artículo', 'Artículo'), ('Libro', 'Libro'), ('Capítulo de libro', 'Capítulo de libro'), ('Documento resultado de investigación', 'Documento resultado de investigación')], max_length=100, null=True),
        ),
        migrations.AlterField(
